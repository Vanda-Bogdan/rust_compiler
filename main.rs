fn main() {
    ...
    let decimalLiteral : i32 = 1_0_0_0_9_9_9;   // Десятичная запись (нижние подчекривания в качестве украшения)
    let octalLiteral : i32 = 0o_1_2_3_4_5_6_7;  // Восьмеричная запись (нижние подчекривания в качестве украшения)
    let binaryLiteral : i32 = 0b_111_000;   // Двоичная запись (нижние подчекривания в качестве украшения)
    let hexLiteral : i32 = 0x0____9____a____F;   // Шестнадцатиричная запись (нижние подчекривания в качестве украшения, поддерживает верхний и нижний регистр)

    // Символьные литералы
    /*
    * QUOTE_ESCAPE (\' | \")
    * ASCII_ESCAPE (\x7F | \n | \r | \t | \\ | \0)
    * UNICODE_ESCAPE (\u{7FFF}) до 6 чисел в фигурных скобках
    */
    ...
    charLiteral = '\u{1___0___F____FFF__}';  // Верхняя граница \u{10FFFF}, допустимо использование '_' между символами и в конце
    ...
    */
    ...
    \u{1___0___F____FFF__}".to_string();
